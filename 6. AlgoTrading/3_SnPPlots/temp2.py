...
snp500_10 = snpReturns('2014-01-01', today).resample('M').last()
snp500_5 = snpReturns('2018-01-01', today).resample('M').last()
snp500_2 = snpReturns('2021-01-01', today).resample('M').last()
snp500_1 = snpReturns('2022-01-01', today).resample('M').last()
